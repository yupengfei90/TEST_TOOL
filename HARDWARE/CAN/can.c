...
u8 CAN2_Mode_Init(u8 tsjw,u8 tbs2,u8 tbs1,u16 brp,u8 mode)
{
    ...
    //使能相关时钟
  	...
  	RCC_APB1PeriphClockCmd(RCC_APB1Periph_CAN1|RCC_APB1Periph_CAN2, ENABLE);//使能CAN1,CAN2时钟(CAN2不能单独使用)
    ...
    GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化PA11,PA12
  	...
  	CAN_Init(CAN2, &CAN_InitStructure);   // 初始化CAN2
		...
		//配置过滤器
 	  CAN_FilterInitStructure.CAN_FilterNumber=14;	  //过滤器14(cAN2过滤器从14开始)
